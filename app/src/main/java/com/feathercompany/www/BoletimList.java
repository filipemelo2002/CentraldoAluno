...
public class BoletimList extends AppCompatActivity {
    private List<Boletim> dataset;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boletim_list);
        ...
        ListView list = findViewById(R.id.boletins);
        ...
        if(dataset.size()>0){
            BoletimAdapter adapter = new BoletimAdapter(this, dataset);
